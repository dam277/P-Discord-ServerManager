...
class CreatePrivateChannel(Create):
    ...
    @Command.register(name="create_private_channel", description="Create a private channel into the discord server which will make the users able to join it and automatically create a new private category for him", parent="/create", channel_name="Name of the channel")
