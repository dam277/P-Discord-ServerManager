...
class Setup(Command):
    ...
    @Command.register(name="/setup", description="Setup the server to the database")
    ...
    @Command.permissions([DiscordPermissions.manage_guild])
    @Command.register(name="subSetup1", description="Setup the server to the database", parent="/setup")
    async def executete(self, interaction: nextcord.Interaction):
        """ # Setup command execution
    ...
    @Command.permissions([DiscordPermissions.manage_guild])
    @Command.register(name="subSetup2", description="Setup the server to the database", parent="/setup")
    async def executetedsdsd(self, interaction: nextcord.Interaction):
        """ # Setup command execution
    ...
    @Command.permissions([DiscordPermissions.manage_guild])
    @Command.register(name="subSetup1Child", description="Setup the server to the database", parent="subSetup1")
    async def executetete(self, interaction: nextcord.Interaction):
        """ # Setup command execution
    ...
    @Command.permissions([DiscordPermissions.manage_guild])
    @Command.register(name="subSetup1ChildChild", description="Setup the server to the database", parent="subSetup1Child")
    async def executetete(self, interaction: nextcord.Interaction):
        """ # Setup command execution
    ...
    @Command.permissions([DiscordPermissions.manage_guild])
    @Command.register(name="asas", description="Setup the server to the database")
    async def asas(self, interaction: nextcord.Interaction):
        """ # Setup command execution
    ...
    @Command.permissions([DiscordPermissions.manage_guild])
    @Command.register(name="asasas", description="Setup the server to the database", parent="asas")
    async def asasas(self, interaction: nextcord.Interaction):
        """ # Setup command execution
