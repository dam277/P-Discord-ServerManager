...
class Database:
    ...
    def __init__(self):
        ...
        try:
            ...
            lg.Logger.log(lg.LogDefinitions.SUCCESS, f"connected to the database")
        except Exception as e:
            lg.Logger.log(lg.LogDefinitions.ERROR, f"Exception while connecting to database : {e}")
    ...
    async def bind_exec(self, query, values):
        ...
        try:
            ...
            lg.Logger.log(lg.LogDefinitions.ERROR, f"Exception while using database binded execute : {err}")
            return err, False
    ...
    async def simple_exec(self, query):
        ...
        try:
            ...
            lg.Logger.log(lg.LogDefinitions.ERROR, f"Exception while using database simple execute : {err}")
            return err, False