...
class NoteList(Table):
    ...
    def __init__(self, id: int, name: str, fk_file: int, fk_server: int):
    ...
    async def get_all_note_lists() -> dict[bool, Union[list["NoteList"], str]]:
        ...
        # Execute the query
        result = await Database.get_instance(NoteList.DATABASE).simple_exec(query)
    ...
    async def get_note_list_by_id(id_note_list: int) -> dict[bool, Union["NoteList", str]]:
        ...
        # Execute the query
        result = await Database.get_instance(NoteList.DATABASE).bind_exec(query, {"id_noteList" : id_note_list})
    ...
    async def get_note_list_by_name(name: str) -> dict[bool, Union["NoteList", str]]:
        ...
        # Execute the query
        result = await Database.get_instance(NoteList.DATABASE).bind_exec(query, {"name" : name})
    ...
    async def get_note_list_id_by_name_and_fk_server(name: str, fk_server: int) -> dict[bool, Union[int, str]]:
        ...
        # Execute the query
        result = await Database.get_instance(NoteList.DATABASE).bind_exec(query, {"name" : name, "fk_server" : fk_server})
    ...
    @staticmethod
    async def get_note_list_by_name_and_fk_server(name: str, fk_server: int) ->  dict[bool, Union["NoteList", str]]:
    ...
    @staticmethod
    async def get_notelists_by_server_id(id_server: int) -> dict[bool, Union[list["NoteList"], str]]:
        ...
        # Execute the query
        result = await Database.get_instance(NoteList.DATABASE).bind_exec(query, {"fk_server" : id_server})
    ...
    @staticmethod
    async def create_note_list(name: str, fk_file: int|None, fk_server: int) -> dict[bool, Union[MySQLCursor, str]]:
        ...
        # Execute the query
        result = await Database.get_instance(NoteList.DATABASE).bind_exec(query, {"name" : name, "fk_file" : fk_file, "fk_server" : fk_server})

        # Return the result
        return result
    
    @staticmethod
    async def delete_note_list_by_id(note_list_id: int) -> dict[bool, Union[MySQLCursor, str]]:
        ...
        # Execute the query
        result = await Database.get_instance(NoteList.DATABASE).bind_exec(query, {"id_noteList" : note_list_id})
    ...
    def create_object(row: list) -> "NoteList":
        ...
        id = row.get("id_noteList") if "id_noteList" in row else None
