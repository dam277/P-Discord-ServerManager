...
class Bot:
    ...
    ---
        ...
        Bot
    """
    def __init__(self, command_prefix: str, intents: nextcord.Intents, discord_token: str, db_name: str):
        ...
        load_dotenv()
        self.configs = {"discord_token": discord_token, "db_host": os.getenv("DB_HOST"), "db_port": os.getenv("DB_PORT"), "db_user": os.getenv("DB_USER"), "db_password" : os.getenv("DB_PASSWORD"), "db_name": db_name}
